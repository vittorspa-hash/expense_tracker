...
Il progetto include una test suite  di **84 unit test** con **~97% di coverage** sui componenti core.
...
| **CurrencyService** | 15 | 94.1% | Persistenza, HTTP mocking, network-cache strategy, multi-valuta |
